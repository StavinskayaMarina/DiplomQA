...
public class DataHelper {
    ...
    public User getInalidUser() {
        return new User("log1234", "pass1234");
    }
    ...
    public static class RandomCategory {
        static final Random randomCategory = new Random();
        ...
        public static String randomCategory() {
            ...
            return category[randomCategory.nextInt(category.length)];
        }
    }
